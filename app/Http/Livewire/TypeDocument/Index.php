...
namespace App\Http\Livewire\TypeDocument;

use Livewire\Component;
use Illuminate\Foundation\Auth\Access\AuthorizesRequests;
use Livewire\WithPagination;
use App\Models\{TypeDocument, Role};
...
class Index extends Component
{
    ...
    {
        return view('livewire.type-document.index', [
            'items' => TypeDocument::paginate(10),
        ]);
    }
    ...
    */
    ...
    public function editItem($uuid){
        try {
            ...
            $item = TypeDocument::whereUuid($uuid)->first();
    ...
    public function updateItem()
    {
        ...
        try {
            ...
            TypeDocument::whereuuid($this->itemId)->first()->update([
                'nom' => $this->nom
            ]);
    ...
    public function deleteItem($uuid)
    {
        try{
            ...
            TypeDocument::whereUuid($uuid)->delete();
